 ...
 *   groupBy [string]: Field to group portcos by (e.g. 'sector' or 'location').
...
class SearchSection extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="ovc-portco-search-menu">
        <Nav className="ovc-portco-search-section-tabs"
             bsStyle="tabs"
        ...
        <div className="ovc-portco-search-dropdown">
          <label>Group by</label>
          <DropdownButton className="dropdown-button"
                          title={this._GROUP_BY_DISPLAY_MAP[this.props.groupBy]}
                          id="ovc-portco-search-dropdown">
        ...
        <div className="ovc-portco-search-inputs">
        ...
        <div className="ovc-portco-search-tags">
          {tags}
        </div>
      </div>
    );
